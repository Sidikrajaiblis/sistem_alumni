            ...
            <div class="row g-4">
                <div class="col-lg-6 d-flex">
                    <div class="card-body">
                        ...
                        <p class="mb-0">Enter your credentials to register your account</p>

                        <!-- Optional: social login -->
                        <div class="row gy-2 gx-0 my-4">
                            <div class="col-12">
                                <button class="btn btn-filter py-2 px-4 font-text1 fw-bold w-100">
                                    <img src="{{ asset('admin/images/apps/05.png') }}" width="20" class="me-2">Sign up with Google
                                </button>
                            </div>
                            <!-- Tambah Facebook/LinkedIn jika perlu -->
                        </div>

                        <div class="separator">
                            <div class="line"></div>
                            <p class="mb-0 fw-bold">OR SIGN UP WITH EMAIL</p>
                            <div class="line"></div>
                        </div>

                        <!-- FORM REGISTER -->
                        <form method="POST" action="{{ route('register') }}" class="row g-3 mt-4" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-12">
                                ...
                                <input id="foto" type="file"
                                    ...
                                    name="foto" value="{{ old('foto') }}" autocomplete="foto" accept="image/*">
